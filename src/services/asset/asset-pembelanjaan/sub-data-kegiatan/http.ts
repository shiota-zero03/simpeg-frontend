...
export const getAllSubDataKegiatanOption = async (): Promise<ISubDataKegiatanOptionRes> => {
...
export const getAllSubDataKegiatan = async (
  ...
  const response = await instance.get(`/admin/sub-kegiatan?${params.toString()}`);
  return response.data;
};
...
export const getDetailSubDataKegiatan = async (id: string): Promise<ISubDataKegiatanDetailRes> => {
...
export const updateSubDataKegiatan = async (
  ...
  const response = await instance.put(`/admin/sub-kegiatan/update/${id}`, formData);
  return response.data;
};
export const deleteSubDataKegiatan = async (id: string): Promise<ISubDataKegiatanDetailRes> => {
