...
export const getAllSuratPemeriksaan = async (
  ...
  const response = await instance.get(
    `/admin/surat-pemeriksaan?${params.toString()}`,
  );
  return response.data;
};
export const getAllListSuratPemeriksaan =
  async (): Promise<ISuratDDPemeriksaanDetaiRes> => {
    const response = await instance.get(
      `/admin/surat-pemeriksaan/list/dropdown`,
    );
    return response.data;
  };
export const createSuratPemeriksaan = async (
  ...
  const response = await instance.post(
    `/admin/surat-pemeriksaan/create`,
    formData,
  );
  return response.data;
};
export const getDetailSuratPemeriksaan = async (
  id: string,
): Promise<ISuratPemeriksaanDetaiRes> => {
...
export const updateSuratPemeriksaan = async (
  ...
  const response = await instance.put(
    `/admin/surat-pemeriksaan/update/${id}`,
    formData,
  );
  return response.data;
};
export const deleteSuratPemeriksaan = async (
  id: string,
): Promise<ISuratPemeriksaanDetaiRes> => {
  const response = await instance.delete(
    `/admin/surat-pemeriksaan/delete/${id}`,
  );
  return response.data;
};
