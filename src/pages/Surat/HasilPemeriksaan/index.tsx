...
import {
  useDeleteHasilPemeriksaan,
  useGetAllHasilPemeriksaan,
} from "@/services/surat/hasil-pemeriksaan";
...
export default function HasilPemeriksaan() {
  ...
  const {
    ...
    refetch: refetchData,
  } = useGetAllHasilPemeriksaan(pageIndex + 1, limit, search, searchNo);
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-2 justify-center">
            <Button
              onPress={() => {
                navigate(`/laporan-hasil-pemeriksaan/detail-data/${id}`);
              }}
              isIconOnly
              radius="sm"
              size="sm"
  ...
  const { mutate: mutateDelete } = useDeleteHasilPemeriksaan();
  ...
  return (
    <>
      <BreadcrumbAdmin location="/Laporan-Hasil-Pemeriksaan" />
      <DeleteModal
        isOpen={isOpenDelete}
        onClose={onCloseDelete}
      ...
      <div className="md:p-8 p-4 grid grid-cols-1 gap-8">
        <div className="flex items-center justify-between gap-2 md:flex-row flex-col">
          <TitleCase
            title="Daftar Laporan Hasil Pemeriksaan"
            text="Berikut ini Mengelola Daftar Laporan Hasil Pemeriksaan"
          />
          <Button
            onPress={onOpenKop}
            ...
            <div className="pt-8 px-4 w-full text-primary shadow-sm">
              <div className="flex sm:flex-row flex-col justify-between gap-2 sm:items-end">
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <Button
                    onPress={() =>
                      navigate(`/laporan-hasil-pemeriksaan/tambah-data`)
                    }
                    variant="solid"
                    radius="sm"
                    size="sm"
