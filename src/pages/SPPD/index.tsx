      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-2 justify-center">
            <Button onPress={() => navigate(`/news/edit-data/${id}`)} isIconOnly radius="sm" size="sm" className="bg-alert-info text-info shadow-sm">
              <LuPencilLine size={14} />
            </Button>
            <Button onPress={onOpenDelete} isIconOnly radius="sm" size="sm" className="bg-alert-danger text-danger shadow-sm">
              <LuTrash2 size={14} />
            </Button>
          </div>
        )
    ...
    <>
      ...
      <div className="md:p-8 p-4 grid grid-cols-1 gap-8">
        ...
        <div className="bg-white shadow-md rounded-xl border">
            ...
            <div>
                <div className="py-8">
                    <DataTables isLoading={false} columns={columns} data={paginatedData} />
                </div>
            </div>
