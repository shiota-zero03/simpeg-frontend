...
export default function UpdateNews() {
    ...
    return (
        ...
        <ConfirmModal isOpen={isOpenConfirm} onClose={onCloseConfirm} isLoading={isLoadingConfirm} handleSubmit={handleConfirm} />
        <div className="md:p-8 p-4 grid grid-cols-1 gap-8">
            ...
            <div className="bg-white shadow-md rounded-xl border p-4">
                <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
                    <div>
                        <div className='mb-1'>
                            <label htmlFor="content" className='font-semibold text-xs'>Judul <span className="text-danger">*</span></label>
                        </div>
                        <Input
                    ...
                    <div>
                        <div className='mb-1'>
                            <label htmlFor="content" className='font-semibold text-xs'>Isi Konten <span className="text-danger">*</span></label>
                        </div>
                        <CKEditor
                    ...
                    <div className='max-w-80'>
                        <div className='mb-1'>
                            <label htmlFor="content" className='font-semibold text-xs'>Foto <span className="text-danger">*</span></label>
                        </div>
                        ...
                        <input type="file" onChange={handleChangeImage} accept='.png,.jpg,.jpeg' />
                        <div className="text-danger text-[0.7rem] mt-1">
                            {formError.thumbnail}
                        </div>
                    </div>
                    <div className='ms-auto'>
                        <Button isLoading={isLoadingConfirm} className='bg-button-primary text-white' size='sm' radius='sm' type='submit'>
                            <LuSave /> Simpan Data
                        </Button>
                    </div>
                </form>
