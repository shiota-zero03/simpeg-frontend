        ...
        <>
            <div className="md:p-8 p-4 grid grid-cols-1 gap-8">
                <div className="bg-[#137269] min-h-48 w-full lg:rounded-bl-[6rem] rounded-bl-[3rem] lg:rounded-tr-[6rem] rounded-tr-[3rem] lg:rounded-tl-3xl rounded-tl-[3rem] lg:rounded-br-3xl rounded-br-[3rem] flex justify-center flex-col overflow-hidden relative z-0">
                    <img src={WaveDashboard} alt="wave-dashboard" loading="lazy" className="absolute right-0 top-0 w-52 z-0 md:block hidden" />
                    <img src={WaveDashboard} alt="wave-dashboard" loading="lazy" className="absolute right-52 bottom-0 w-36 rounded-tr-[4rem] scale-y-[-1] z-0 lg:block hidden" />
                    <div className="flex items-center justify-between md:flex-row flex-col lg:px-12 sm:px-10 px-2 gap-4">
                        <div className="flex flex-col md:items-start items-center md:text-left text-center text-white gap-1.5 relative z-10">
                            <h1 className="lg:text-3xl sm:text-2xl text-lg font-semibold my-1">Berita Terkini</h1>
                            <p className="lg:text-sm text-xs font-light">Dinas Perdagangan Kabupaten Bekasi</p>
                        </div>
                        <div>
                            <Input
                                aria-label="search"
                                ...
                                endContent={<button className="bg-accent-primary text-white md:p-2 p-1 -me-2 rounded-full border"><LuSearch /></button>}
                                className="xl:w-96 md:w-52 w-full"
                                variant="bordered"
                                classNames={{
                                    inputWrapper: "bg-white/20 border border-white md:h-12 h-10",
                                    input: "placeholder:text-white placeholder:italic font-light text-white"
                                }}
                                size="sm"
                            />
                        </div>
