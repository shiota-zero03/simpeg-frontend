...
export default function Header() {
    const berita = [
        { title: "Untuk penambahan alokasi pupuk, harap menghubungi Dinas Pertanian" },
                    ...
                    <div className="lg:flex flex-col gap-1 hidden">
                        <div className="flex overflow-hidden items-center">
                            <div className="flex items-center gap-2 text-accent-primary font-bold text-sm w-[118px]">
                                <GrAnnounce className="-rotate-12" size={14} />Berita Terkini
                            </div>
                            <div className="me-3 font-bold text-primary">|</div>
                            <div className="relative w-[40%] overflow-hidden">
                                <div className="marquee">
                                    {[...berita, ...berita].map((item, index) => (
                                        <span key={index} className="text-sm font-semibold">{item.title} &nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp; </span>
                                    ))}
                                </div>
                            </div>
                        </div>
