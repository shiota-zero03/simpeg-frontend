...
const EditPenilaianNilai = ({ nama, jabatan, nip, isOpen, onClose, handleClose }: props) => {
    ...
    const handleChangeFile = async (e: React.ChangeEvent<HTMLInputElement>, type: "kinerjaAttach" | "disiplinAttach" | "loyalitasAttach" | "kerjasamaAttach" | "attitudeAttach") => {
          ...
          <ModalBody className="max-h-[72vh] overflow-y-auto overflow-y-custom flex flex-col gap-2 pb-8">
            <div className="overflow-x-auto flex flex-col gap-4">
                <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                    <Input radius="sm" variant="bordered" label={"Nama"} labelPlacement="outside" isDisabled type="text" value={nama} />
                    <Input radius="sm" variant="bordered" label={"Jabatan"} labelPlacement="outside" isDisabled type="text" value={jabatan} />
                    <Input radius="sm" variant="bordered" label={"NIP"} labelPlacement="outside" isDisabled type="text" value={nip} />
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFormData({...formData, kinerja: Number(e.target.value)})}
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <Input
                            ...
                            onChange={(e) => setFormData({...formData, loyalitas: Number(e.target.value)})}
                            placeholder="Masukkan Disini"
                            classNames={{
                                input: "text-xs",
                            }}
