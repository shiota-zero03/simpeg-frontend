...
import { useGetDetailDataKegiatan, useUpdateDataKegiatan } from "@/services/asset/asset-pembelanjaan/data-kegiatan";
...
const UpdateModal = ({ id, isOpen, onClose, handleClose }: props) => {
  ...
  const { data, isFetching, refetch } = useGetDetailDataKegiatan(String(id));
  ...
  const { mutate: mutatePost } = useUpdateDataKegiatan();
      ...
      <Modal isOpen={isOpen} backdrop="blur" hideCloseButton size="3xl">
        <ModalContent>
          ...
          <ModalHeader className="flex items-center justify-between">
            <span className="text-base font-semibold">Update Data Kegiatan</span>
            <LuX
