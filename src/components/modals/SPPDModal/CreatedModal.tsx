...
const CreateModal = ({ isOpen, onClose, handleClose }: props) => {
  ...
  const handleChangeValue = (e: React.ChangeEvent<HTMLInputElement>) => {
    const inputVal = e.target.value.replace(/\D/g, ""); // Hanya angka
          ...
          <ModalBody className="max-h-[72vh] overflow-y-auto overflow-y-custom flex flex-col gap-2 pb-8">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Autocomplete
                  ...
                  onSelectionChange={(value) =>
                    setFormData({ ...formData, pegawai: Number(value) })
                  }
                  inputProps={{
                    classNames: {
                      input: "text-xs",
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="flex flex-col gap-1 md:col-span-1 col-span-3">
                <label htmlFor="tanggal" className="text-xs font-semibold">
                  Waktu Pelaksanaan <span className="text-danger">*</span>
                </label>
                <DatePicker
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-1">
                <label htmlFor="lokasi" className="text-xs font-semibold">
                  Pengikut <span className="text-danger">*</span>
                </label>
                  ...
                  <div key={index} className="flex items-center gap-2">
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        (newPengikut[index] as string) = e.target.value;
              ...
              <div>
                <button
                  onClick={addPengikut}
                  className="flex items-center gap-2 bg-accent-primary w-auto text-white text-xs px-2 py-1 rounded-full"
                >
