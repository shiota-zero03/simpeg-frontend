...
const ExportExcelIKP = lazy(() => import("@/pages/export/excel/IKPExport"));
...
const ExportWordSuratPemanggilan = lazy(
  () => import("@/pages/Surat/Pemanggilan/Word"),
);
    ...
    <Suspense fallback={<LoaderPage />}>
      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route
            path="/manajemen-aset/tambah-item-belanja"
            element={<AssetItemCreated />}
          />
        ...
        <Route
          path="/dialog-kinerja/export-excel/:id"
          element={<ExportExcelIKP />}
        />
        ...
        />
        <Route
          path="/surat-pemanggilan/export-word/:id"
          element={<ExportWordSuratPemanggilan />}
        />
        <Route
