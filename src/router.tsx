...
const CreateSuratPemeriksaan = lazy(() => import("@/pages/Surat/Pemeriksaan/Created"));
const ViewSuratPemeriksaan = lazy(() => import("@/pages/Surat/Pemeriksaan/Detail"));
const ExportSuratPemeriksaan = lazy(() => import("@/pages/Surat/Pemeriksaan/Export"));
const SuratPemanggilan = lazy(() => import("@/pages/Surat/Pemanggilan"));
const CreateSuratPemanggilan = lazy(() => import("@/pages/Surat/Pemanggilan/Created"));
const ViewSuratPemanggilan = lazy(() => import("@/pages/Surat/Pemanggilan/Detail"));
const ExportSuratPemanggilan = lazy(() => import("@/pages/Surat/Pemanggilan/Export"));
    ...
    <Suspense fallback={<LoaderPage />}>
      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/surat-perintah-pemeriksaan" element={<SuratPemeriksaan />} />
          <Route path="/surat-perintah-pemeriksaan/tambah-data" element={<CreateSuratPemeriksaan />} />
          <Route path="/surat-perintah-pemeriksaan/detail-data/:id" element={<ViewSuratPemeriksaan />} />
          <Route path="/surat-pemanggilan" element={<SuratPemanggilan />} />
          <Route path="/surat-pemanggilan/tambah-data" element={<CreateSuratPemanggilan />} />
          <Route path="/surat-pemanggilan/detail-data/:id" element={<ViewSuratPemanggilan />} />
        </Route>
        ...
        />
        <Route path="/surat-perintah-pemeriksaan/export-data/:id" element={<ExportSuratPemeriksaan />} />
        <Route path="/surat-pemanggilan/export-data/:id" element={<ExportSuratPemanggilan />} />
